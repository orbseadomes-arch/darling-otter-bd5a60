    ...
    <nav className="nav-blur fixed top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-0 py-0 flex items-center justify-between">
        <a href="#hero" className="flex items-center gap-0">
          <img src={`${import.meta.env.BASE_URL}logo-v4a.png`} alt="OrbSea" className="h-20 w-auto" />
        </a>
...
>
  ...
  <input type="hidden" name="_subject" value="New OrbSea Enquiry!" />
  ...
  <div>
    ...
    >
      ...
      <option value="resort-partnership">
        Resort / Developer Partnership
      </option>
